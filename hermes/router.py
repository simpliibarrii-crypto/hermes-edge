...
INTENT_RULES: list[IntentRule] = [
    ...
    IntentRule(r'\b(web |search |find |look up|google|who is |define )', INTENT_TOOLS, 0.90),
    IntentRule(r'\b(what is (the |a |an ))(?!meaning|purpose|point|reason)', INTENT_TOOLS, 0.88),
